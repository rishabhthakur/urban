...
(function() {
  ...
  ImagePicker = (function() {
    ...
    ImagePicker.prototype.create_picker = function() {
      this.picker = jQuery("<ul class='thumbnails image_picker_selector'><div class='row'></di></ul>");
      this.picker_options = [];
    ...
    ImagePicker.prototype.recursively_parse_option_groups = function(scoped_dom, target_container) {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        container = jQuery("<ul><div></div></ul>");
        container.append(jQuery("<li class='group_title'><div class='col-md-2'>" + (option_group.attr("label")) + "</div></li>"));
